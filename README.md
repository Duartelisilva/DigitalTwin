For my thesis project, I developed a digital twin of a 1:43 scale autonomous racing system using Unity. I created the virtual environment and assets, as well as integrating them into a functional simulation.

I modeled the race track and race cars in Blender to accurately represent the real-world system and imported them into Unity to build the digital twin environment. In Unity, I configured the scene, scaling, physics, and interactions required for realistic behavior. I developed scripts, in C#, to send control commands to the real cars via TCP, simulate the virtual cars using the same dynamics as the real vehicles, and perform real-time monitoring of the physical system. A dedicated environment was also implemented to support reinforcement learning algorithms. The resulting platform enables real-time visualization, monitoring, and simulation of the race cars, providing a safe and flexible foundation for testing control strategies and training machine-learning models.
